...
#   vcn_id         = local.create_vcn ? oci_core_vcn.vlz_vcn[0].id : data.oci_core_vcn.vlz_vcn[0].id
# }
...
#   compartment_id = var.tenancy_ocid
#   vcn_id         = local.create_vcn ? oci_core_vcn.vlz_vcn[0].id : var.vcn_id
...
resource "oci_core_subnet" "vlz_subnet" {
  ...
  dhcp_options_id     = local.create_vcn ? oci_core_vcn.vlz_vcn[0].default_dhcp_options_id : data.oci_core_vcn.vlz_vcn[0].default_dhcp_options_id
}
...
resource "oci_core_instance_pool" "media_instance_pool" {
  ...
  placement_configurations {
    availability_domain = data.oci_identity_availability_domain.ad.name
    primary_subnet_id   = local.num_of_subnets == 0 ? data.oci_core_subnet.vlz_subnet[0].id : oci_core_subnet.vlz_subnet[count.index].id
...
#       create_vnic_details {
#         subnet_id                 = local.num_of_subnets == 0 ? data.oci_core_subnet.vlz_subnet[0].id : oci_core_subnet.vlz_subnet[0].id
...
#       content {
#         create_vnic_details {
#           subnet_id                 = local.num_of_subnets == 0 ? data.oci_core_subnet.vlz_subnet[0].id : oci_core_subnet.vlz_subnet[1].id
#           assign_private_dns_record = true
#           assign_public_ip          = true
...
#   placement_configurations {
#     availability_domain = data.oci_identity_availability_domain.ad.name
#     primary_subnet_id   = local.num_of_subnets == 0 ? data.oci_core_subnet.vlz_subnet[0].id : oci_core_subnet.vlz_subnet[0].id
#     fault_domains       = local.fault_domains
